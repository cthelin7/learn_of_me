<template>
    <v-card flat variant="tonal" color="blue-lighten-3" class="ma-3">
...
<script>
  ...
  export default {
    name: 'QuoteCard',
    props: {
        quote: {type: Object, default: {text: "default", link: "www.google.com", linkText: "Google"}}
    },
    data() {
      return {
        JesusPic: JesusPic,
    ...
    methods: {
        next(){
            ...
            this.openingQuote = false;
            this.$emit("next-btn-event");
        }
    }
  }
</script>
